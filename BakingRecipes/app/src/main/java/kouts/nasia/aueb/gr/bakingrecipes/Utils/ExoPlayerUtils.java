...
public class ExoPlayerUtils {
    ...
    private ImageView refreshMedia;
    ...
    public ExoPlayerUtils(@NonNull final Activity activity,
        ...
        this.refreshMedia = refreshMedia;

        if(ConfigurationsInfo.onPhoneLandscape(activity)) {
            Transformations.hideSystemUI(activity);

                ViewGroup.LayoutParams playerViewParams = exoPlayerView.getLayoutParams();
                int[] screenDimens = ConfigurationsInfo.findScreenDimens(activity);
        ...
        networkConnectivityReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(final Context context, final Intent intent) {
                if (NetworkConnectivity.isNetworkAvailable(activity) && repairNeeded &&  stopWaitingForConnecion) {
                    repairNeeded = false;
                    restorePlaying();
                }
            }
        ...
        if(thumbnailUri != null){
            try{
                ...
                // in any case that exception is thrown just ignore thumbnail and not show anything
            }
        ...
        public void onPlayerError(ExoPlaybackException error) {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    startPos = getContentPosition();
                    Toast.makeText(activity, activity.getString(R.string.error_media_player),
